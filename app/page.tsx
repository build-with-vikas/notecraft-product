...
const tools: { id: Tool; label: string; eyebrow: string; description: string; icon: typeof Layers3; color: string }[] = [
  { id: 'merge', label: 'Merge PDFs', eyebrow: '01', description: 'Combine files into one ordered document.', icon: Layers3, color: '#6d5dfc' },
  { id: 'split', label: 'Split PDF', eyebrow: '02', description: 'Separate pages or sections into new files.', icon: Scissors, color: '#ff795f' },
  { id: 'jpg', label: 'PDF to JPG', eyebrow: '03', description: 'Turn every page into a crisp image.', icon: FileImage, color: '#2fbf9f' },
  { id: 'image-pdf', label: 'Images to PDF', eyebrow: '04', description: 'Build a PDF from JPG or PNG files.', icon: FilePlus2, color: '#efb84a' },
  { id: 'pptx', label: 'PPTX to images', eyebrow: '05', description: 'Extract slide media locally from presentations.', icon: FileStack, color: '#ee6ca4' },
]
