...
const tools: { id: Tool; label: string; eyebrow: string; description: string; icon: typeof Layers3; color: string }[] = [
  ...
  { id: 'pipeline', label: 'Smart Arrange', eyebrow: '06', description: 'Chain several operations into one run.', icon: Sparkles, color: '#5b6fa8' },
]
