...
export default function Page() {
  ...
  return <main className="nc-shell" style={{ '--scroll-progress': scrollProgress, '--pointer-x': pointer.x, '--pointer-y': pointer.y } as React.CSSProperties}>
