...
const pipelineTools: { id: PipelineStep; label: string }[] = [
  { id: 'split', label: 'Split PDF' },
  { id: 'merge', label: 'Merge PDFs' },
  { id: 'jpg', label: 'Convert to JPG' },
]
