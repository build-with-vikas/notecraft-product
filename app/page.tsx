...
export default function Page() {
  ...
  return <main className={`nc-shell mode-${mode}`} style={{ '--scroll-progress': scrollProgress, '--hero-progress': heroProgress, '--pointer-x': pointer.x, '--pointer-y': pointer.y } as React.CSSProperties}>
    ...
    <footer className="nc-footer"><div className="footer-brand"><svg className="footer-mark" viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg"><path d="M50 4 L92 18 L92 55 C92 80 74 98 50 106 C26 98 8 80 8 55 L8 18 Z" fill="none" stroke="#3B9DF8" strokeWidth="5" /><text x="50" y="66" textAnchor="middle" fontFamily="Georgia, serif" fontSize="42" fill="#3B9DF8">D</text></svg><strong className="footer-title">DBMCI one</strong></div><nav><a href="#studio">Studio</a><a href="#tools">Tools</a><a href="#method">Method</a></nav><div className="footer-rule" /><p>© 2026 DBMCI One. Document tools for everyday work.</p></footer>
  </main>
}